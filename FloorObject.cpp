...
void FloorObject::transform()
{
	...
	this -> transformedLightPos = this -> lightPos;// * cm -> getCam1() -> getProjMatrix();  Looks like I do not need this for now
	
}

void FloorObject::setRenderState()
{
	CameraManager* cm = CameraManager::getInstance();
