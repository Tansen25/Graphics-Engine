...
void Camera::setDir(const Vect &inDir)
{
	this -> vDir = inDir;
}

void Camera::getLookAtPos( Vect &outLookAt) const
{
	outLookAt = this -> vLookAtPos;
}

void Camera::setLookAtPos(const Vect &inLookAt)
{
	this -> vLookAtPos = inLookAt;
}
